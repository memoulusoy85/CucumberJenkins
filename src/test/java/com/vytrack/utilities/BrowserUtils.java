...
public class BrowserUtils {
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assert.assertTrue("Element not visible: ",Driver.get().findElement(by).isDisplayed());
    ...
    public static void verifyElementNotDisplayed(By by) {
        ...
        Assert.assertFalse("Element should not be visible: ",Driver.get().findElement(by).isDisplayed());
        } catch (NoSuchElementException e) {
            e.printStackTrace();
